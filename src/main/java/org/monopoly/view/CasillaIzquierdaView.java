...
public class CasillaIzquierdaView extends CasillaView {
    public CasillaIzquierdaView(Casilla casilla, List<Jugador> jugadores) {
    ...
    protected Node getCasillaView(VBox jugadores, Label info){
        HBox cView = new HBox(jugadores, info);
        cView.setAlignment(Pos.CENTER_RIGHT);
